...
- **Soundboard vocal** : le sélecteur contient toujours un serveur virtuel **FavoriteRandom**, juste sous les favoris, dans les vocaux de serveur comme dans les appels privés en DM. **Lecture directe** joue immédiatement un son aléatoire ; son **Aperçu sécurisé** reste indépendant et confirme une lecture dans le vocal.
